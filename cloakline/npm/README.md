...
That downloads platform-native binaries + scripts from the [latest GitHub Release](https://github.com/flyhighbarney/cloak/releases) and runs the platform's bootstrap installer.
...
See the full [project README](https://github.com/flyhighbarney/cloak) and [docs/GUIDE.md](https://github.com/flyhighbarney/cloak/blob/main/docs/GUIDE.md) for architecture, security model, and troubleshooting.
